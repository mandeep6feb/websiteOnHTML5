    ...
    <!-- <img src="img/about/14.jpg" alt=""class="al" style="width: 100%;height: 350px;padding: 0rem"></a> -->
		...
		<!-- ========================about us======================================================================================= -->
			<section class="content_info padding-top-10" id="about-us "style="background-color:white">
				...
				<div style="font-size:32px;font-weight:600;text-align:center">PRINTED LABEL</div>
						...
						<div class="col-md-12" style="text-transform: none;">
							...
							<div class="container">
									<section class="customer-logos slider" >
											...
											<div>
													<img src="img/Product/printed/p1.jpg" alt="">
													
													<h4><strong> Print On Cotton Tape</strong></h4>
												</div>
												<div>
													<img src="img/Product/printed/p2.jpg" alt="">
													
													<h4><strong> Print On Polyester Tape</strong></h4>
												</div>
												<div>
													<img src="img/Product/printed/p3.jpg" alt="">
													
													<h4><strong>Screen print On Cloth</strong></h4>
												</div>
												<div>
													<img src="img/Product/printed/p4.jpg" alt="">
													
													<h4><strong> Colored Satin Ribbed</strong></h4>
												</div>
												<div>
													<img src="img/Product/printed/p5.jpg" alt="">
													
													<h4><strong>Silver Print On Tape </strong></h4>
												</div>
												<div>
													<img src="img/Product/printed/p6.jpg" alt="">
													
													<h4><strong>Offset Print</strong></h4>
												</div>
												<div>
													<img src="img/Product/printed/p7.jpg" alt="">
													
													<h4><strong>Embossed Print</strong></h4>
												</div>
												<div>
													<img src="img/Product/printed/p8.jpg" alt="">
													
													<h4><strong> Sparkee Print</strong></h4>
												</div>
												<div>
													<img src="img/Product/printed/p9.jpg" alt="">
													
													<h4><strong> Woven Edge Print</strong></h4>
												</div>
					...
					<h2>Printed labels are : </h2><br>
						<p>
						1             Cotton Labels (White Cotton & Kora Color tapes) Focus printing <br>
						2             Cotton Labels (White Cotton & Kora Color tapes) Screen printing <br>
						3             Six/Eight Color printed Labels <br>
						4             Printed Labels with Security Inks <br>
						5             Black Tape / White Screen Printing. <br>
						6             Sublimation printing on Polyester Tapes <br>
						7             Sublimation printing on felt. <br>
						8             Some Other Unique Qualities in Printed Labels. <br>
						</p>
					</div>
						<br><br>
