    ...
    <!-- <img src="img/about/14.jpg" alt=""class="al" style="width: 100%;height: 350px;padding: 0rem"></a> -->
					...
					<div class="container">
						<div class="col-md-12">
								...
								A COMPLETE BRANDING SOLUTION</div>
                                ...
                                <p class="mt-4 mb-3" style=" text-align: justify;
                                text-justify: inter-word; list-style: initial;line-height: 25px"> 
                                For more than three decades, Atam Associates has been producing the <span style="font-weight: 800">finest labels</span> in the world. We've been helping customers,<span style="font-weight: 800"> both big and small,</span> produce high quality labels that help <span style="font-weight: 800">differentiate their products </span>in the market place. We not only use the<span style="font-weight: 800"> most sophisticated production equipments,</span> but our<span style="font-weight: 800"> advanced quality control systems</span> ensure that your labels are the <span style="font-weight: 800">highest quality every time.</span>
								</p>
							<div style="height: 2px;background-color: rgba(14, 0, 0, 0.507)"></div>

							</div>

							<div class="col-md-6">
								<h5 class="mt-3" style="text-align: left">We offer following Branding Merchandise</h5>
								<div class="row col-md-12 ml-1 p-3 mt-1 ">
                                <ul style="list-style: circle;">
                                    <li style="text-align: left;"><a class="page-scroll" href="pro-woven.php">Woven Labels</a></li><div style="height: 7px;"></div>
									<li style="text-align: left;"><a class="page-scroll" href="pro-printed.php">Printed Labels</a></li><div style="height: 7px;"></div>
									<li style="text-align: left;"><a class="page-scroll" href="pro-hangtag.php">Hangtags</a></li><div style="height: 7px;"></div>
									<li style="text-align: left;"><a class="page-scroll" href="pro-tagsealers.php">Tag Sealers</a></li><div style="height: 7px;"></div>
                                    
                                    <li style="text-align: left;"><a class="page-scroll" href="pro-heat.php">Heat Transfer Labels</a></li><div style="height: 7px;"></div>
									<li style="text-align: left;"><a class="page-scroll" href="pro-narrow.php">Narrow Woven Fabric Tapes</a></li><div style="height: 7px;"></div>
									<li style="text-align: left;"><a class="page-scroll" href="pro-boxes.php">Boxes</a></li><div style="height: 7px;"></div>
									<!-- <li style="text-align: left;"><a class="page-scroll" href="pro-button.php">Metal Buttons</a></li><div style="height: 7px;"></div> -->
									<li style="text-align: left;"><a class="page-scroll" href="pro-batch.php">Batches</a></li><div style="height: 7px;"></div>
									<li style="text-align: left;"><a class="page-scroll" href="pro-bar.php">Bar code Solutions</a></li>
								</ul>
								
							</div>

							<!-- <div style="height: 2px;background-color: rgba(14, 0, 0, 0.507)"></div> -->
								<h5  style="text-align: left">Environment Friendly Products</h5>
								<div class="row col-md-12 ml-1 p-3 mt-1 mb-5">
                                <ul style="list-style: square;">
								<li style="text-align: left;"><a class="page-scroll" href="gogreen.php">Click Here To Check Our Eco-Friendly Product !!</a></li><div style="height: 7px;"></div>
                                    <li style="text-align: left;"><a class="page-scroll" href="faq.php">Click Here To Additional Inquiries FAQ ? !!</a></li><div style="height: 7px;"></div>
									<!-- <li style="text-align: left;"><a class="page-scroll" href="pro-printed.html">Printed Labels</a></li><div style="height: 7px;"></div> -->
									<!-- <li style="text-align: left;"><a class="page-scroll" href="pro-hangtag.html">Hangtags</a></li><div style="height: 7px;"></div> -->
									<!-- <li style="text-align: left;"><a class="page-scroll" href="pro-button.html">Metal Buttons</a></li><div style="height: 7px;"></div> -->
									<!-- <li style="text-align: left;"><a class="page-scroll" href="pro-patch.html">Back And Jacket Patches</a></li><div style="height: 7px;"></div> -->
									<!-- <li style="text-align: left;"><a class="page-scroll" href="pro-bar.html">Barcode Solutions</a></li> -->
								</ul>
						  ...
						  <!-- <div class="col-md-6">
								<section class="customer-logos slider">
										<div>
											<h6 class="mt-3"><strong>Worldwide Logistics</strong></h6>
											<img src="img/new banners images/1w (Case Conflict).png" alt="">
										</div>
										<div>
											<h6 class="mt-3"><strong>Sustainable Branding Solutions</strong></h6>
											<img src="img/new banners images/2s (Case Conflict).png" alt="">
										</div>
										<div>
											<h6 class="mt-3"><strong>Bespoke Branding Solutions</strong></h6>
												<img src="img/new banners images/3b (Case Conflict).png"alt="">
										</div>
										<div>
											<h6 class="mt-3"><strong>Innovative</strong></h6>
												<img src="img/new banners images/4i (Case Conflict).png" alt="">
										</div>
