...
<div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:350px;overflow:hidden;visibility:hidden;">
    ...
    <div>
                ...
                <div data-u="caption" data-t="3" style="position:absolute;top:60px;left:560px;width:320px;height:40px;font-size:28px;font-weight:400;line-height:1;text-align:center;padding:0.5rem; color:#fff;">Tag Sealers</div>
	...
	<div class="paddings">
		<div class="container" >
			<div class="section-title-wrap margin-bottom-10" ><!-- section title -->
				<div style="font-size:32px;font-weight:600;text-align:center">TAG SEALERS</div>
