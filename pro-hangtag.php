...
<section class="content_info padding-top-10" id="about-us" style="background-color:white">
		<div class="paddings">
			...
			<br><br>
				...
				<div style="font-size:32px;font-weight:600;text-align:center">HANGTAGS</div>
			...
			<div class="col-md-12" style="text-transform: none;">
				...
				<section class="customer-logos slider">
							...
							<div>
								<img src="img/Product/hangtags/h1.jpg" alt="">
								<h4><strong>2 Piece Set With PVC String</strong></h4>
							</div>
							<div>
								<img src="img/Product/hangtags/h2.jpg" alt="">
								<h4><strong> Adhesive Size Label</strong></h4>
							</div>
							<div>
								<img src="img/Product/hangtags/h3.jpg" alt="">
								<h4><strong>Hangtag With UV Varnish </strong></h4>
							</div>
							<div>
								<img src="img/Product/hangtags/h4.jpg" alt="">
								<h4><strong> Full Foil Printed With Emboss Effect</strong></h4>
							</div>
							<div>
								<img src="img/Product/hangtags/h5.jpg" alt="">
								<h4><strong> Button Tag</strong></h4>
							</div>
							<div>
								<img src="img/Product/hangtags/h6.jpg" alt="">
								<h4><strong>Leaf Printed Tag</strong></h4>
							</div>
							<div>
								<img src="img/Product/hangtags/h7.jpg" alt="">
								<h4><strong> Diecut Hangtag</strong></h4>
							</div>
							<div>
								<img src="img/Product/hangtags/h8.jpg" alt="">
								<h4><strong>Metalic Paper Tag</strong></h4>
							</div>
							<div>
								<img src="img/Product/hangtags/h9.jpg" alt="">
								<h4><strong>Offset Printed Tag </strong></h4>
							</div>
							<div>
								<img src="img/Product/hangtags/h10.jpg" alt="">
								<h4><strong>Canvas Tag With Jute String </strong></h4>
							</div>       
						</section>
						</div>
					</div> 
					...
					<div class="col-md-12 m-5">
						<p class="text-justified">Hang labels are not just for brand data purposes. They increase the value of your garments by emphatically recognizing your image and items in plain view in an advanced, proficient manner. Cruz Label can make greatly proficient, 100% altered silk screened hang labels or woven labels for all organizations beginning from  <br>little new businesses to expansive companies. <br><br>
						When it comes to making unique hang label plans, the sky is the breaking point! Hang labels can be innovatively created with altered shapes, materials, hues, completes, thicknesses, overlays, and considerably more. <br><br>
						On the off chance that you claim a dress line or satchel organization and your objective is to offer your things in boutiques or retail establishments, then you ought to have hang labels to brand your items and give your organization name acknowledgment. Most retail chains and boutiques won’t purchase your pieces of clothing or things in the event that they are not completely marked and labeled professionally.</p>
					</div>
