...
<br><br>
				...
				<div style="font-size:32px;font-weight:600;text-align:center">WOVEN LABELS</div>
			...
			<div class="col-md-12" style="text-transform: none;">
				...
				<div class="container">
								<img src="img/Product/WOVAN LABEL.png" style="width: 350px;margin:auto" alt="">
				<section class="customer-logos slider">
							<div>
								<h6>Embossing In Woven Labels</h6>
							</div>
							<div>
								<!-- <img src="img/Product/WOVAN LABEL.png" alt=""> -->
								<h6> Woven Labels with Cotton Warps</h6>
							</div>
							<div>
								<!-- <img src="img/Product/WOVAN LABEL.png" alt=""> -->
								<h6> Colored Warp Samples</h6>
							</div>
							<div>
								<!-- <img src="img/Product/WOVAN LABEL.png" alt=""> -->
								<h6>Hand Made Woven Labels (Khaddi Looms)</h6>
							</div>
							<div>
								<!-- <img src="img/Product/WOVAN LABEL.png" alt=""> -->
								<h6> Needle Loom Labels</h6>
							</div>
							<div>
								<!-- <img src="img/Product/WOVAN LABEL.png" alt=""> -->
								<h6>Woven Labels with Sublimation Printing</h6>
							</div>
							<div>
								<!-- <img src="img/Product/WOVAN LABEL.png" alt=""> -->
								<h6>Book Fold Labels</h6>
							</div>
							<div>
								<!-- <img src="img/Product/WOVAN LABEL.png" alt=""> -->
								<h6> Some other unique qualities in Woven Labels</h6>
							</div>
							<div>
								<!-- <img src="img/Product/WOVAN LABEL.png" alt=""> -->
								<h6> Laser Cut Labels</h6>
							</div>
							<div>
								<!-- <img src="img/Product/WOVAN LABEL.png" alt=""> -->
								<h6>Woven badges with Merrowing</h6>
							</div>
							<div>
								<!-- <img src="img/Product/WOVAN LABEL.png" alt=""> -->
								<h6>Gumming Labels (When we iron labels got permanently sticked)</h6>
							</div>
					...
					<h2>Woven labels are : </h2><br>
						<p>
						1             Embossing In Woven Labels <br>
						2             Woven Labels with Cotton Warps <br>
						3             Colored Warp Samples <br>
						4             Hand Made Woven Labels (Khaddi Looms) <br>
						5             Needle Loom Labels <br>
						6             Woven Labels with Sublimation Printing <br>
						7             Book Fold Labels <br>
						8             Some other unique qualities in Woven Labels <br>
						9             Laser Cut Labels <br>
						10            Woven badges with Merrowing etc. <br>
						11            Gumming Labels (When we iron labels got permanently sticked)
						</p>
					</div>
			<br><br>
